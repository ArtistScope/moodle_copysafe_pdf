...
/**
 * This page lists all the instances of CopysafePdf in a particular course
 *
 * @author  ArtistScope
...
add_to_log($course->id, 'CopysafePdf', 'view all', "index.php?id=$course->id", '');
...
if (! $newmodules = get_all_instances_in_course('CopysafePdf', $course)) {
